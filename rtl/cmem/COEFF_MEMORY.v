...
//      version:		2008Q3V1
//      comment:		
//      configuration:	 -instname "COEFF_MEMORY" -words 64 -bits 16 -frequency 1 -ring_width 2.0 -mux 2 -write_mask off -wp_size 8 -top_layer "m6-m8_m4" -power_type rings -horiz met3 -vert met2 -cust_comment "" -bus_notation on -left_bus_delim "[" -right_bus_delim "]" -pwr_gnd_rename "VDD:VDD,GND:VSS" -prefix "" -pin_space 0.0 -name_case upper -check_instname on -diodes on -inside_ring_type GND -drive 4 -asvm on -corners ff_1p32v_m55c,ff_1p65v_125c,tt_1p2v_25c,ss_1p08v_m55c
//
//      Verilog model for Synchronous Single-Port Register File
//
//      Instance Name:              COEFF_MEMORY
//      Words:                      64
//      Bits:                       16
//      Mux:                        2
//      Drive:                      4
...
//      Test Muxes                  Off
//
//      Creation Date:  2022-12-03 20:29:35Z
//      Version: 	2008Q3V1
//
