...
read_verilog [list "../../rtl/fsm/$top_level.v" "../../rtl/fsm/fir_buffer.v"]
read_verilog [list "../../rtl/add/add.v" "../../rtl/add/cla.v" "../../rtl/add/fa.v" "../../rtl/add/ha.v"]
read_verilog {../../rtl/cmem/cmem.v}
read_verilog [list "../../rtl/dmem/dmem.v" "../../rtl/dmem/dmem10.v"]
read_verilog [list "../../rtl/multiply/multiply.v" "../../rtl/multiply/regne.v" "../../rtl/multiply/shiftlne.v" "../../rtl/multiply/shiftrne.v"]
