...
## Setting files/paths
set verilog_files {../../dc/dmem/dmem.nl.v}
set my_toplevel dmem
set search_path [list "." ". /courses/ee6321/share/ibm13rflpvt/synopsys/"]
set link_path ["* scx3_cmos8rf_lpvt_tt_1p2v_25c.db", "/user/stud/spring22/ma4107/csee4823/fir/dc/cmem/COEFF_MEMORY_tt_1p2v_25c_syn.db"
...
read_vcd "../../qsim_dc/dmem/dmem.vcd" -strip_path "tb_dmem/dmem_0"
...
write_sdf -context verilog "./dmem.sdf"
