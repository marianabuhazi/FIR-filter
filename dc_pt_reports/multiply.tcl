...
## Setting files/paths
set verilog_files {../../dc/multiply/multiply.nl.v}
set my_toplevel multiply
...
read_vcd "../../qsim_dc/multiply/multiply.vcd" -strip_path "tb_multiply/multiply_0"
...
write_sdf -context verilog "./multiply.sdf"
